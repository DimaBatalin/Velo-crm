...
def _build_detail_response(repair: Repair) -> RepairDetailResponse:
...
async def create_repair(
    ...
    repair = Repair(**repair_data.model_dump())
...
async def update_repair(
    ...
    if update_fields.get("status") == RepairStatus.DONE and not repair.completed_at:
...
@router.delete("/{repair_id}/services/{repair_service_id}")
...
@router.delete("/{repair_id}/parts/{repair_part_id}")
